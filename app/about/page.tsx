  ...
  return (
    <>
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-12 lg:gap-24 items-start mb-20 md:mb-32">
          <div
            className="space-y-6 font-sans text-text-muted max-w-md leading-relaxed text-base md:text-lg"
            data-about-el
          >
            <p>
          ...
          <div className="lg:sticky lg:top-24" data-about-el>
            <blockquote className="font-serif text-[clamp(1.75rem,3.5vw,2.75rem)] leading-[1.1] text-text-primary">
        ...
        <div
          className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 pt-12 border-t border-rule"
          data-about-el
        >
          <div className="flex flex-col gap-3">
            <p className="font-mono text-[11px] uppercase tracking-[0.25em] text-text-dim mb-2">
              Education
            </p>
            <div className="flex items-baseline gap-4 pb-2 border-b border-rule">
              ...
              <span className="font-sans text-sm text-text-primary">
                MSc International Business — The George Washington University
              </span>
            </div>
            <div className="flex items-baseline gap-4 pb-2 border-b border-rule">
              <span className="font-mono text-xs text-text-muted w-20 shrink-0">
              ...
              <span className="font-sans text-sm text-text-primary">
                LL.M Bar-Certified — University of Nebrija, Madrid
              </span>
            </div>
            <div className="flex items-baseline gap-4 pb-2 border-b border-rule">
              <span className="font-mono text-xs text-text-muted w-20 shrink-0">
              ...
              <span className="font-sans text-sm text-text-primary">
                LL.B Law — University of Seville
              </span>
            </div>
            <div className="flex items-baseline gap-4">
              ...
              <span className="font-sans text-sm text-text-primary">
                Study abroad — Università di Bologna
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-baseline gap-4 pb-2 border-b border-rule">
              ...
              <span className="font-sans text-sm text-text-primary">
                Oxford Certificate · Chief of Staff at MS IB
              </span>
            </div>
            <div className="flex items-baseline gap-4 pb-2 border-b border-rule">
              <span className="font-mono text-xs text-text-muted w-20 shrink-0">
              ...
              <span className="font-sans text-sm text-text-primary">
                Hispanic Bar Association D.C. · Volunteer in VA
              </span>
            </div>
            <div className="flex items-baseline gap-4 pb-2 border-b border-rule">
              <span className="font-mono text-xs text-text-muted w-20 shrink-0">
              ...
              <span className="font-sans text-sm text-text-primary">
                Captain — University of Seville Soccer Team
              </span>
            </div>
            <div className="flex items-baseline gap-4">
              <span className="font-mono text-xs text-text-muted w-20 shrink-0">
